...
class TestGetRangeNodesIntegr extends GroovyTestCase {
  ...
  @Test
	  void testGetRangeNodesMixedRange2() {
		...
		@Test
			void testGetRangeNodesFrom2col1() {
				CtsUrn urn = new CtsUrn("urn:cts:croala:kunicr.ilias.croala_ohco2:1.head-1.10")
					...
					assert response.size() == 11
					assert response[0]['rangeNode'].nodeUrn.toString() == "urn:cts:croala:kunicr.ilias.croala_ohco2:1.head"
					assert response[10]['rangeNode'].nodeUrn.toString() == "urn:cts:croala:kunicr.ilias.croala_ohco2:1.10"
