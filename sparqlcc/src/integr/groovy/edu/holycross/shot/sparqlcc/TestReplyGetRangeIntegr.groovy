...
"""
  ...
  void testGetRangeOrdered2(){
    ...
    //Set up params
    String reqString = "GetRange"
    Cite2Urn reqUrn = new Cite2Urn("urn:cite2:hmt:venAsign.v1:5.v1-7")
...
<GetRange xmlns="http://chs.harvard.edu/xmlns/cite" xmlns:cite="http://chs.harvard.edu/xmlns/cite">
<cite:request>
    <requestUrn>urn:cite2:hmt:venAsign.v1:5.v1-7.v1</requestUrn>
    <request>GetRange</request>
    <resolvedUrn>urn:cite2:hmt:venAsign.v1:5.v1-7.v1</resolvedUrn>
</cite:request>
<cite:reply>
...
"""
  ...
  void testGetRangeUnordered1(){
    ...
    //Set up params
    String reqString = "GetRange"
    Cite2Urn reqUrn = new Cite2Urn("urn:cite:hmt:vaimg.VA082RN_0083-VA094RN_0095")
