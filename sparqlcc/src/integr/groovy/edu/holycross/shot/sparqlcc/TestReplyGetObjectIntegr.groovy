...
"""
  ...
  void testGetObjectOrdered2(){
    ...
    //Set up params
    String reqString = "GetObject"
    CiteUrn reqUrn = new CiteUrn("urn:cite:hmt:venAsign.6.v1")
...
<GetObject xmlns="http://chs.harvard.edu/xmlns/cite" xmlns:cite="http://chs.harvard.edu/xmlns/cite">
<cite:request>
    <requestUrn>urn:cite:hmt:venAsign.6.v1</requestUrn>
    <request>GetObject</request>
    <resolvedUrn>urn:cite:hmt:venAsign.6.v1</resolvedUrn>
</cite:request>
<cite:reply>
...
"""
  ...
  void testGetObjectOrdered3(){
    ...
    //Set up params
    String reqString = "GetObject"
    CiteUrn reqUrn = new CiteUrn("urn:cite:hmt:venAsign.7.v1")
...
<GetObject xmlns="http://chs.harvard.edu/xmlns/cite" xmlns:cite="http://chs.harvard.edu/xmlns/cite">
<cite:request>
    <requestUrn>urn:cite:hmt:venAsign.7.v1</requestUrn>
    <request>GetObject</request>
    <resolvedUrn>urn:cite:hmt:venAsign.7.v1</resolvedUrn>
</cite:request>
<cite:reply>
...
"""
  ...
  void testGetObjectUnordered2(){
    ...
    //Set up params
    String reqString = "GetObject"
    CiteUrn reqUrn = new CiteUrn("urn:cite:hmt:vaimg.VA094RN_0095.v1")
