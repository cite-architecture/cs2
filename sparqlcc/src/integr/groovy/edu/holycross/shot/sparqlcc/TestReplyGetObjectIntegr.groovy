...
<GetObject xmlns="http://chs.harvard.edu/xmlns/cite" xmlns:cite="http://chs.harvard.edu/xmlns/cite">
<cite:request>
    <requestUrn>urn:cite2:hmt:venAsign.v1:6.v1</requestUrn>
    <request>GetObject</request>
    <resolvedUrn>urn:cite2:hmt:venAsign.v1:6.v1</resolvedUrn>
</cite:request>
<cite:reply>
...
<GetObject xmlns="http://chs.harvard.edu/xmlns/cite" xmlns:cite="http://chs.harvard.edu/xmlns/cite">
<cite:request>
    <requestUrn>urn:cite2:hmt:venAsign.v1:7.v1</requestUrn>
    <request>GetObject</request>
    <resolvedUrn>urn:cite2:hmt:venAsign.v1:7.v1</resolvedUrn>
</cite:request>
<cite:reply>
...
<GetObject xmlns="http://chs.harvard.edu/xmlns/cite" xmlns:cite="http://chs.harvard.edu/xmlns/cite">
<cite:request>
    <requestUrn>urn:cite2:hmt:venAsign.v1:8.v1</requestUrn>
    <request>GetObject</request>
    <resolvedUrn>urn:cite2:hmt:venAsign.v1:8.v1</resolvedUrn>
</cite:request>
<cite:reply>
    <citeObject urn="urn:cite2:hmt:venAsign.v1:8">
        <citeProperty name="CriticalSign" label="A URN identifying the kind of critical sign" type="Cite2Urn">urn:cite:hmt:critsigns.asterisk</citeProperty>
        <citeProperty name="Label" label="Label" type="string">Sign 8.v1</citeProperty>
        <citeProperty name="OccurrenceUrn" label="The URN for this occurrence of a critical sign" type="Cite2Urn">urn:cite2:hmt:venAsign.v1:8.v1</citeProperty>
        ...
        <prevUrn>urn:cite2:hmt:venAsign.v1:7.v1</prevUrn>
        <nextUrn>urn:cite2:hmt:venAsign.v1:9.v1</nextUrn>
    </citeObject>
</cite:reply>
</GetObject>
"""
...
"""
  ...
  void testGetObjectUnordered2(){
    ...
    //Set up params
    String reqString = "GetObject"
    Cite2Urn reqUrn = new Cite2Urn("urn:cite:hmt:vaimg.VA094RN_0095")
...
<GetObject xmlns="http://chs.harvard.edu/xmlns/cite" xmlns:cite="http://chs.harvard.edu/xmlns/cite">
<cite:request>
    <requestUrn>urn:cite:hmt:vaimg.VA094RN_0095.v1</requestUrn>
    <request>GetObject</request>
    <resolvedUrn>urn:cite:hmt:vaimg.VA094RN_0095.v1</resolvedUrn>
</cite:request>
<cite:reply>
    <citeObject urn="urn:cite:hmt:vaimg.VA094RN_0095">
        <citeProperty name="Image" label="Image URN" type="Cite2Urn">urn:cite:hmt:vaimg.VA094RN_0095.v1</citeProperty>
