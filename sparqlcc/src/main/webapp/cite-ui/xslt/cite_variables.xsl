...
<xsl:stylesheet
    ...
    <xsl:variable name="getObjectUrl">http://localhost:8080/sparqlcc/api?request=GetObjectPlus&amp;stylesheet=cite_getobject&amp;urn=</xsl:variable>
    <xsl:variable name="imgThumbUrl">http://localhost:8080/sparqlimg/api?request=GetBinaryImage&amp;w=100&amp;urn=</xsl:variable>
    <xsl:variable name="imgLinkUrl">http://localhost:8080/sparqlimg/api?request=GetImagePlus&amp;stylesheet=cite_getimageplus&amp;urn=</xsl:variable>
    <xsl:variable name="imgICTUrl">http://localhost:8080/sparqlimg/ict.html?urn=</xsl:variable>
    <xsl:variable name="ctsUrl">http://localhost:8080/sparqlcts/api?request=GetPassagePlus&amp;stylesheet=cts_passage&amp;urn=</xsl:variable>
